  ...
  const NOTIFS = [
    {
      ...
      desc: 'En 20 minutos: "Meeting with legal team" (08:30 AM)',
      time: 'Hace 5 min',
      unread: true,
      color: 'bg-amber-500',
    },
    {
      ...
      desc: 'No olvides registrar GPS al llegar a "Ginn\'s Coffee Club".',
      time: 'Hace 1 hora',
      unread: true,
      color: 'bg-brand-600',
    },
    {
      id: '3',
      title: 'Nueva asignación de cliente',
      desc: 'Tu supervisor te asignó la cuenta "Agropecuaria El Triunfo".',
      time: 'Ayer',
      unread: false,
      color: 'bg-teal-500',
    },
