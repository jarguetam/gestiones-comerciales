...
- [ ] 1.6 Funciones núcleo: subordinados(), estructura_comercial(), visitas_del_dia(), visita_checkin/checkout, dashboard_asesor/supervisor/gerente, formulario_enviar, modulo_activo. *(aplicadas: subordinados, estructura_comercial, visitas_del_dia, visita_checkin, visita_completar, visita_revisar, visita_corregir, visita_anular)*
- [ ] 1.7 RLS en 100% de tablas de negocio (patrón tenant + alcance por rol). *(aplicada a las 11 tablas F0 + persona, dispositivo (F1.1) y actividad, sub_actividad, actividad_hora, visita (F1.2) = 16 tablas)*
- [ ] 1.8 Seeds por defecto (estados visita, config rastreo, persona genérica por asesor). *(aplicados: catálogo de módulos, geografía GT y catálogos de visita por rubro agro/consumo/farmacia — 003_catalogos_visita.sql)*
...
- [ ] 1.10 Web MVP: W-01 login, W-02/02b dashboards (con drill-down), W-03 visitas, W-04 personas (CRUD+import), W-11 estructura comercial, W-14 mapa (asesores y clientes). *(W-01 login listo; W-03 visitas implementado en la UI interactiva de agenda/timeline/detalle con modal de nueva visita y dropdowns dependientes actividad→sub_actividad; W-04 personas con cartera real del asesor; desplegado en GitHub Pages)*
