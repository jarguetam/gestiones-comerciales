...
| Fase actual | **F3 cerrada**. UI de W-05/M-05 formularios dinámicos en este cambio. Pendiente operativo: MFA, P-05/P-06, W-12/W-14, cola offline móvil, `db push` F3.6. |
...
2. **Cierre de producto (fuera de F0–F3):** MFA, P-05/P-06, W-12 auditoría, W-14 mapa, M-08/M-09 offline. W-05/M-05 formularios dinámicos: renderer + score + envío (demo y RPC `formulario_enviar`).
