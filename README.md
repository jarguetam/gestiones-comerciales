...
| Fase actual | **F3 cerrada**. Web empresa: W-01 MFA TOTP, W-02b drill-down, W-12 auditoría, W-13 notifs y theming `tenant.branding`. Pendiente operativo: P-05, cola offline móvil, `db push` F3.6 + `mapa_recorrido`. |
...
2. **Cierre de producto (fuera de F0–F3):** P-05 catálogos globales, M-08/M-09 cola offline móvil. Web empresa ya cubre W-01 MFA TOTP, W-02b, W-12 y W-13.
