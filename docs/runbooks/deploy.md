...
2. Staging remoto optativo: `supabase-staging.yml` + `e2e-staging.yml` solo con `ENABLE_STAGING=true` (Vite en el runner, nunca Pages). Desarrollo ordinario usa Supabase local.
